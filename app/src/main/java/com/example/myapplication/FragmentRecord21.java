...
public class FragmentRecord21 extends Fragment {
    ...
    String[] legendName = {"X-axis :Total Income","Y-axis:Month","X","Y"};


    @Override
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
                             Bundle savedInstanceState) {
        View v = inflater.inflate( R.layout.fragment_record21, container, false );

        mpLineChart = (LineChart) v.findViewById( R.id.line_chart3 );
